...
class MockEntities {
    companion object {
        ...
        val game1 = Game(1, 1, 1,"Game 1", "In Progress", 1, 1, todayStart, todayStart, todayEnd, emptyList(), settings, leaderBoard)
        val game2 = Game(2, 1, 1,"Game 2", "In Progress", 1, 1, todayStart, todayStart, todayEnd, emptyList(), settings, leaderBoard)
        val game3 = Game(3, 1, 1,"Game 3", "In Progress", 1, 1, todayStart, todayStart, todayEnd, emptyList(), settings, leaderBoard)
        val game4 = Game(4, 1, 1,"Game 4", "In Progress", 1, 1, todayStart, todayStart, todayEnd, emptyList(), settings, leaderBoard)
